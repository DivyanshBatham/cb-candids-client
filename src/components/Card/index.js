...
import { showShareMenu } from '../../actions/shareAction';
import './card.scss';
import Tag from '../Tag';
...
class Card extends Component {
  ...
  shareLink = (e) => {
    ...
    this.props.showShareMenu(title, url);
  }
  render() {
    const {
      openDescription,
...
export default connect(mapStateToProps, { deletePost, showShareMenu })(withRouter(Card));
